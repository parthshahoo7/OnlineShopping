...
//========================= Delete Account If ADMIN===================================
	...
	public String deleteProduct(@Valid Account account, BindingResult bindingResult, Model model) {
		...
		System.out.println(accountDao.deleteAccount(account));
		return "redirect:/deleteCustomerConfirmation";
	}

//================================ Delete Account Confirmation==================================
	@RequestMapping(value = "/deleteCustomerConfirmation", method = RequestMethod.GET)
	public String deleteProductConfirmation(@Valid Account account, BindingResult bindingResult, Model model) {
		return "deleteCustomerConfirmationPage";
	}
